...
func TestNoDirIgnoreFile(t *testing.T) {
	v := validator.NewOpenAPISpecCodeDiffsValidator("", "./sample-app1/.apiignore", "./sample-app1", "./sample-app1/api-spec.yaml")
	err, _ := v.Validate()
	assert.Error(t, err, "Error has occurred: "+err.Error())
}

func TestNoIgnoredAPIFile(t *testing.T) {
	v := validator.NewOpenAPISpecCodeDiffsValidator("./sample-app1/.dirignore", "", "./sample-app1", "./sample-app1/api-spec.yaml")
	err, _ := v.Validate()
	assert.Error(t, err, "Error has occurred: "+err.Error())
}

func TestNoSourceDir(t *testing.T) {
	v := validator.NewOpenAPISpecCodeDiffsValidator("./sample-app1/.dirignore", "./sample-app1/.apiignore", "", "./sample-app1/api-spec.yaml")
	err, _ := v.Validate()
	assert.Error(t, err, "Error has occurred: "+err.Error())
}

func TestNoAPIFile(t *testing.T) {
	v := validator.NewOpenAPISpecCodeDiffsValidator("./sample-app1/.dirignore", "./sample-app1/.apiignore", "./sample-app1", "")
	err, _ := v.Validate()
	assert.Error(t, err, "Error has occurred: "+err.Error())
}
